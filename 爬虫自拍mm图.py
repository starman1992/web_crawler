...
def get_imgs(url):
    p = r'<img class="lazy" src="[^"]+\.png" data-original="([^"]+\.jpg)"'
...
def savepic(folder='美女test'):
    os.chdir('C:\\Users\\WXYZ\\Desktop')
    os.makedirs(folder,exist_ok=True)
    os.chdir(folder)
  
    for page in range(399,400):
        url = f'https://www.mzitu.com/zipai/comment-page-{page}/#comments'
        print(url)
